...
const Footer = () => {
  return (
    <>
      <div className=' flex px-6 md:px-12 py-8 bg-[#2A254B]  w-[1440px] h-[380px]'>
        <div className="flex flex-wrap gap-12 md:gap-[60px] lg:gap-[60px]">
          {/* Menu Section */}
        ...
        <div className='flex flex-wrap justify-between items-center text-white gap-4'>
          <div>
            <h1>Copyright 2022 Avion LTD. Shakir Sarwar</h1>
          </div>
